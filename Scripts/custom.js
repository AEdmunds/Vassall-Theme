...
jQuery(window).load(function(){
    ...
    //scriptTag.src = '<script src="//platform.linkedin.com/in.js" type="text/javascript"></script><script type="IN/FollowCompany" data-id="3333263" data-counter="none"></script>';
    //scriptTag.async = true;
    //jQuery("#linked-in-follow")[0].appendChild(scriptTag);
